    ...
    <div className="min-h-screen bg-[#f9f9f9]">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">Staycation Price Tracker</h1>

          <div className="bg-white p-8 rounded-xl shadow-sm mb-12">
            <h2 className="text-2xl font-semibold mb-6">Save Money on Your Staycation</h2>

            <div className="space-y-6">
              <div className="border-l-4 border-black pl-4 py-2">
                <p className="text-lg">
                  I'm building a tool that helps staycation guests{" "}
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  After you book a local hotel for your staycation, enter your booking details (like hotel name,
                  check-in/check-out, and what you paid).
                </li>
                <li>
              ...
              <p>
                It's especially helpful for staycation planners who book early, because prices can go down later. It's
                like having a smart assistant always looking for better deals after you book.
              </p>
            </div>
          </div>

          <div className="bg-white p-8 rounded-xl shadow-sm">
            <h2 className="text-2xl font-semibold mb-6">Start Tracking Your Staycation Booking</h2>
